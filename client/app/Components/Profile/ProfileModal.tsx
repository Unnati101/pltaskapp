...
function ProfileModal() {
  ...
  return (
    <div className="fixed text-black left-0 top-0 z-50 h-full w-full bg-[#333]/30 overflow-hidden">
      <div
        ref={ref}
      ...
      >
        ...
        <h1 className="flex flex-col text-xl">
          <span className=" font-medium">Hello,<span className="font-bold">{name}</span></span>
        </h1>
